...
@Command
public class Main {
    static java.util.logging.Logger log = Logger.getLogger(Main.class.getName());
    static {
    ...
    @Command
    void replica(@Parameters(paramLabel = "kafkaHost:port") String kafkaHost,
                 @Parameters(paramLabel = "replica-name") String replicaName,
                 @Parameters(paramLabel = "grpcHost:port") String grpcPort,
                 @Parameters(paramLabel = "snapshot-message-threshold") int messageThreshold,
                 @Parameters(paramLabel = "topic-prefix") String topicPrefix) throws IOException, InterruptedException {

        kafkaReplica mainReplica = new kafkaReplica(kafkaHost,replicaName,grpcPort,messageThreshold,topicPrefix);
        mainReplica.startup();
